...
curl -sSL -m 30 -o /tmp/r1282_zrfF.diff "https://base44.app/api/apps/6aa26c7ce0ac9a5ee05d2b95/files/mp/public/6aa26c7ce0ac9a5ee05d2b95/08be9a0a6_r1282_zrfF.diff"
echo "CURL_RC=$?"
